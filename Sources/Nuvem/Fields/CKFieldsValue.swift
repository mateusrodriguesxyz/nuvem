...
public macro CKField(_ key: String? = nil) = #externalMacro(module: "MacroImplementation", type: "CKFieldMacro")

extension CKFields {
    
    @propertyWrapper public struct Default<Value: CKFieldValue>: CKFieldProtocol, _CKFieldProtocol {
    ...
    //            storage.recordValue = recordValue
        ...
        public var projectedValue: CKFields.Default<Value> { self }
