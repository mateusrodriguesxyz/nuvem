...
@propertyWrapper public struct CKReferenceFieldOne<Value: CKModel>: CKReferenceFieldProtocol, _CKFieldProtocol {
    ...
    public var projectedValue: CKReferenceFieldOne<Value> { self }
