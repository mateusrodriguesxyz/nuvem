...
extension CKReferenceFields {
    
    @propertyWrapper public struct Many<Value: CKModel>: CKReferenceListFieldProtocol, _CKFieldProtocol {
        ...
        public var projectedValue: CKReferenceFields.Many<Value> { self }
