...
public func == <Model: CKModel, Value: CKFilterableValue, Mapper: CKFieldValueMapper>(lhs: KeyPath<Model, CKField<Value, Mapper>>, rhs: Value.AttributeValue) -> CKComparisonFilter<Model> {
